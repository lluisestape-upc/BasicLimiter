...
|-----------|-------|---------|-------------|
| Threshold | -60 to 0 dB | 0 dB | Level above which GR engages |
| Release | 10 to 1000 ms | 100 ms | Exponential decay time (log-scaled knob) |
| Out Gain | -12 to +12 dB | 0 dB | Post-limiter makeup gain |
